...
![Version: 1.16.8](https://img.shields.io/badge/Version-1.16.8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.18.1](https://img.shields.io/badge/AppVersion-v0.18.1-informational?style=flat-square)
...
| vcluster | object | `{"coredns":{"replicas":1},"enableHA":false,"replicas":1,"storage":{"persistence":false}}` | Virtual Cluster Configuration. See [vcluster documentation](https://artifacthub.io/packages/helm/loft/vcluster) |
